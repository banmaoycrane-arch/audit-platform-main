...
当前手工凭证录入界面较简陋，凭证日期、凭证字号、会计期间、科目、对方单位等字段没有充分体现真实财务软件的录入习惯和账套上下文，且用户反馈“提交人工凭证失败：Internal Server Error”，需要优先修复提交稳定性。

从会计实务看，手工凭证录入不是简单填几列分录，而应基于账套、会计主体、会计期间、已结账状态、科目档案和往来性质自动提供默认值、选择控件和必要校验。
...
- **WHEN** 当前账套/会计主体存在 open 或 reopened 会计期间
