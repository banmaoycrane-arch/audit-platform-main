...
|------|----------|------|
| 登录 / 团队 / 账簿 | 可用 | L5 |
| 记账（凭证·期间·报表） | 可用，已脚本验收 | L5；**L6 路径 A 16/16 通过（2026-08-01）** |
| 审计 Step1–6 | 可用，已脚本验收 | L5；**L6 路径 B 13/13 通过（2026-08-01）** |
...
| ~~**P0**~~ | ~~记账 L6 路径 A 签字或缺陷台账~~ | **M0** ✅ 2026-08-01 脚本验收 16/16 |
| **P0** | 事件工单 E1：表 → API → 事件卡 UI → steps | **M1** |
| ~~**P0**~~ | ~~审计 L6 路径 B 签字或缺陷台账~~ | **M0** ✅ 2026-08-01 脚本验收 13/13 |
