...
class ParseResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "seal_info": self.seal_info.to_dict() if self.seal_info else None,
...
class LLMComparisonResult:
    ...
    # 各引擎原始结果
    engine_results: dict[str, ParseResult | None] = field(default_factory=dict)
