...
def _contract_to_dict(contract: Contract, db: Session) -> dict[str, Any]:
    ...
    return {
        ...
        "contract_amount": _decimal_to_str(contract.contract_amount),
...
def _bank_to_dict(statement: BankStatement, db: Session) -> dict[str, Any]:
    ...
    return {
        ...
        "amount": _decimal_to_str(statement.amount),
        "balance": _decimal_to_str(statement.balance),
...
def _inventory_to_dict(document: InventoryDocument, db: Session) -> dict[str, Any]:
    ...
    return {
        ...
        "total_amount": _decimal_to_str(document.total_amount),
...
def list_counterparty_balances(db: Session, ledger_id: int) -> list[dict[str, Any]]:
    ...
    for invoice in invoices:
        ...
        amount = Decimal(str(invoice.total_amount)) if invoice.total_amount else Decimal("0.00")
