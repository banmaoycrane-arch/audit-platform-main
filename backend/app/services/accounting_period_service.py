...
class AccountingPeriodService:
    ...
    def get_period_summary(self, period_id: int, dimension_type: str = "period_total") -> dict:
    ...
    def _period_entries_query(self, period: AccountingPeriod):
    ...
    def _build_source_scope(self, period: AccountingPeriod) -> dict:
        return {
            "period_id": period.id,
            "organization_id": period.organization_id,
    ...
    def _format_period_summary(self, period_id: int, dimension_type: str, source: str, items: list[dict]) -> dict:
        return {
            "period_id": period_id,
            "dimension_type": dimension_type,
            "source": source,
    ...
    def _snapshot_to_summary_item(self, snapshot: PeriodSnapshot) -> dict:
        return {
    ...
    def _build_live_summary_items(self, period: AccountingPeriod, dimension_type: str) -> list[dict]:
    ...
    def _build_live_account_summary_items(self, period: AccountingPeriod) -> list[dict]:
        rows = (
    ...
    def _build_live_entity_summary_items(self, period: AccountingPeriod) -> list[dict]:
        rows = (
            self._period_entries_query(period)
            .with_entities(
    ...
    def _build_live_period_total_summary_item(self, period: AccountingPeriod) -> dict:
