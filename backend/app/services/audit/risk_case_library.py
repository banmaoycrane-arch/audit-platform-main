...
from app.services.doc_parsing.vector_store_service import (
    safe_vector_store,
    chunk_hash,
    chunk_text,
)
        ...
        for result in results:
            ...
            if score >= 0.7:  # 相似度阈值
                similar_cases.append({
                    ...
                    "summary_pattern": payload.get("summary_pattern"),
                    "risk_description": payload.get("risk_description"),
                    "audit_suggestion": payload.get("audit_suggestion"),
