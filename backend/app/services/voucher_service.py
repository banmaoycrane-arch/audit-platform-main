...
from app.db.models import AccountingEntry, EntryTag, Voucher
from app.services.entry_tag_service import create_entry_tag
from app.services.entry_tag_rules_engine import apply_auto_tags_to_voucher_lines
from app.services.transaction_service import transaction_with_retry
    ...
    *,
    ...
    def _execute():
        ...
        if ledger_id is None:
            import warnings
            warnings.warn("账簿 ID 为空，这可能导致数据归属不明确", UserWarning)
        ...
        for line_no, line in enumerate(lines, start=1):
            entry = AccountingEntry(
                ...
                debit_amount=float(line.debit_amount or Decimal("0.00")),
                credit_amount=float(line.credit_amount or Decimal("0.00")),
