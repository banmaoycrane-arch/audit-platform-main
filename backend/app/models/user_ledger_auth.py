# -*- coding: utf-8 -*-
"""
模块功能：用户账套授权（UserLedgerAuth）模型定义
业务场景：记录每个用户对哪些账套拥有访问权限，以及权限角色
政策依据：会计信息系统内部控制规范——职责分离与权限管理
输入数据：用户ID、账套ID、角色、授权时间、授权人
输出结果：数据库表 user_ledger_auths，记录用户与账套的授权关系
创建日期：2026-06-18
更新记录：
